...
public class TJPIDController {
    ...
    public TJPIDController(double kP, double kI, double kD, double iZone, double iMax) {
        this.kP = kP;
        this.kI = kI;
        this.kD = kD;
        this.iZone = iZone;
    ...
    public TJPIDController(double kP, double kI, double kD) {
        this(kP, kI, kD, 0, 0);
